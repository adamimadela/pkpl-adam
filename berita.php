...
$query  = $conn->query("SELECT berita.id_berita, berita.isi_berita, berita.judul_berita, berita.tanggal_berita, berita.gambar_berita, kategori.id_kategori, kategori.nama_kategori, aparat.nama_aparat FROM berita LEFT JOIN kategori ON berita.id_kategori = kategori.id_kategori LEFT JOIN aparat ON berita.id_aparat = aparat.id_aparat ORDER BY berita.id_berita DESC");
