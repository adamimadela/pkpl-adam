...
$query  = $conn->query("SELECT berita.id_berita, berita.isi_berita, berita.judul_berita, berita.tanggal_berita, berita.gambar_berita, kategori.id_kategori, kategori.nama_kategori, aparat.nama_aparat FROM berita LEFT JOIN kategori ON berita.id_kategori = kategori.id_kategori LEFT JOIN aparat ON berita.id_aparat = aparat.id_aparat ORDER BY berita.id_berita DESC LIMIT 3");
...
<!-- slideshow -->
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="assets/img/sawahh.jpg" alt="Gambar - 2" width="5px" height="2px">
      <div class="carousel-caption">
        <h3>DESA WATES</h3>
        <p>kec. BUMI RATU NUBAN kab. Lampung Tengah, prov. Lampung</p>
      </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card mb-4 box-shadow">
          <img class="card-img-top" src="assets/img/profilwilayah.png" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card">
          <img class="card-img-top" src="assets/img/visimisi.png" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card mb-4 box-shadow">
          <img class="card-img-top" src="assets/img/aparaturdesa.png" alt="Card image cap">
          <div class="card-body">
...
<div class="judul_section"><h1>POTENSI DAN GALERI</h1><hr></div>  
  <div class="con post">
    <div class="row">
      <div class="col-md-6">
        <div class="card2">
          <img class="card-img-top" src="assets/img/POTENSII.png" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col-md-6">
        <div class="card2">
          <img class="card-img-top" src="assets/img/GALERII.png" alt="Card image cap">
          <div class="card-body">
